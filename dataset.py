...
class ImageCoco(Dataset):
    ...
    def __init__(self, root_directory:str, annFile:str, tokenizer, transform=None, frequency_threshold=1,split_ratio=1):
        super().__init__()
    ...
    def _get_annotations(self, annotation_file):
        ...
        id_to_caption = random.sample(id_to_caption,int(len(id_to_caption) * self.split_ratio))
